            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="active"><a href="contact_user.php" >Contact</a></li>
            ...
            <div class="col-md-12">
              ...
              <div class="row">
                <div class="col-sm-6 col-xs-12">
                  <h2 class="uppercase wow fadeInDown"  data-wow-duration=".8s" data-wow-delay=".2s">Contact us</h2>
                  <span class="line-sep-blue"></span>
                  <p class="wow fadeInUp"  data-wow-duration="1s" data-wow-delay=".3s">
                    EMAIL : mibsys@mail.com
