          ...
          <div class="collapse navbar-collapse" id="navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="active"><a class="text-primary" href="login.php">Login</a></li>
            ...
            <div class="col-md-12">
              ...
              <div class="row">
                <div class="col-md-4 col-md-offset-8 col-lg-offset-8 mar-bottom-md">
                  ...
                  <form action="login_process.php" method="POST" class="mar-top-lg error wow fadeInUp"  data-wow-duration="1s" data-wow-delay=".6s" novalidate="" name="loginForm">
                    <div class="form-group control-group">
                      <input type="email" name="eMail" class="form-control input-lg" id="eMail" placeholder="E-mail* :" required="" data-validation-required-message="Please enter your email address." />
                      <p class="help-block"></p>
                    </div>
                    <div class="form-group control-group">
                      <input type="password" name="uPassword" class="form-control input-lg" id="uPassword" placeholder="Password* :" required="" data-validation-required-message="Please enter your password." />
                      <p class="help-block"></p>
                    </div>
                    <div class="checkbox control-group">
                    </div>
                    <button name="login" type="submit" class="btn btn-primary btn-full btn-lg">Submit</button>
                  </form>
                </div>
              </div>
              <!-- /.row -->
