...
session_start();
$sql = "SELECT * FROM articles WHERE `a_type` ='Melayu Islam Beraja';";
                  ...
                  <?php
                      if($postData > 0){
                        while($row = mysqli_fetch_array($execute)){ 
                          ...
                          <h1 style="text-align: left;"><a href="mibintroduction_user.php?a_id=<?php echo $row['a_id'];?>">Title: <?php echo $row['a_title']; ?></a></h1>
                          <p  style="text-align: right;"><span>Published on <?php echo $date; ?> At: <?php echo $time; ?></span></p>
                          <?php 
                          $firstdesc=substr($row['a_content'], 0, 1500); ?>
                          <p style="text-align: center;"><?php echo $firstdesc;?>.....</p>
                          <label style="font-size:25px;"><a href="mibintroduction_user.php?a_id=<?php echo $row['a_id'];?>">Read More</a></label>
                          <hr>
                          <br>
                          <?php 
                        }
