...
<html  lang="en">
  ...
  <header class="fallone-navbar" data-id="default-navbar">
    ...
    <div class="main-content">
      ...
      <h1 style="font-size:80px; text-align:center;">Melayu Islam Beraja</h1>
        <!-- .container -->
        <div class="container">
          <!-- .row -->
          <div class="row">
                  ...
                  <?php
                      if($postData > 0){
                        while($row = mysqli_fetch_array($execute)){ 
                          ...
                          <h1 style="text-align: left; color: black ;"><a href="mibintroduction.php?a_id=<?php echo $row['a_id'];?>"><?php echo $row['a_title']; ?></a></h1>
                          ...
                          <label style="font-size:20px;"><a href="mibintroduction.php?a_id=<?php echo $row['a_id'];?>">Read More</a></label>
                          <hr>
                          <br >
                          <?php 
                        }
