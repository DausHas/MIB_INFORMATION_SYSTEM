...
session_start();
include_once 'deleteprocess.php';
?>
                  ...
                  <?php
                      if($postData > 0){
                        while($row = mysqli_fetch_array($execute)){ 
                          ...
                          <a href="deleteprocess.php?a_id=<?php echo $row['a_id'];?>"><input type="submit" name="delete" value="Delete Article"><hr>

                          <a href="deleteprocess.php?a_id=<?php echo $row['a_id']; ?>" class="btn btn-primary read-m">DELETE</a>
