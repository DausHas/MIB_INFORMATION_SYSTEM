...
if (isset($_POST["submit"])) {
  ...
  if($row = $sth->fetch())
  {
    ...
    <table>
      <tr href=>
        <th  style="text-align: left; color: black ;font-size:20px;">Title</th>
        <th  style="text-align: left; color: black ;font-size:20px;">Article</th>
        <th  style="text-align: left; color: black ;font-size:20px;">Date created</th>
      </tr>
      <tr>
                    ...
                    <div class="carousel-inner" role="listbox">
                      <div class="item active">
                        ...
                        <div class="carousel-caption">
                          ...
                          <a class="btn btn-primary btn-lg" data-animation="animated zoomInUp" href="mib_user.php">Read More</a>
                        </div>
                      </div>
                      <div class="item">
                        ...
                        <div class="carousel-caption">
                          ...
                          <a class="btn btn-success btn-lg" data-animation="animated zoomInRight" href="ministry_user.php">Read More</a>
                        </div>
                      </div>
                      <div class="item">
                        ...
                        <div class="carousel-caption">
                          ...
                          <a class="btn btn-danger btn-lg" data-animation="animated lightSpeedIn" href="wawasan_user.php">Read More</a>
                        </div>
                      </div>
                    </div>
                  </div>
