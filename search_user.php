...
while($row = mysqli_fetch_assoc($find_article))
{
  ...
  echo "<h5 style='text-align:center; font-size:20px;'> Search Result:<br><hr></h5><p style='text-align:center; font-size:20px;'><a href ='mibintroduction.php?a_id=$id'>$content</a>...<br><hr></p>";
}
